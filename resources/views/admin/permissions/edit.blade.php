...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small>| update permission details for access control system</small>
    </h1>
    <ol class="breadcrumb">
    <li><a href="{{url('dashboard/')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li><a href="{{url('dashboard/permissions/')}}">Permissions</a></li>
      <li><a href="{{url('dashboard/permission/edit/')}}">create-user</a></li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">  
        <div class="box">
          <div class="box-header"> 
            ...
            <a href="{{url('dashboard/permissions/')}}" class="btn btn-sm btn-info pull-right" title="Permissions">
