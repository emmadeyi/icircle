...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <li><a href="{{url('dashboard/')}}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li><a href="{{route('make-payment.index')}}">Contributions</a></li>
    </ol>
    <br>
    <div class="row">
      <div class="col-xs-12">
    ...
    <div class="row">      
      <div class="col-xs-12">  
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form role="form" enctype="multipart/form-data" method="POST" action="{{route('beneficiary-payment.store')}}">
              {{ csrf_field() }}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="beneficiary" style="width: 100%;">
                    <option value="1">John Max</option>
                    <option value="2">Allen Smith</option>
                    <option value="3">Sarah Olen</option>
                  </select>
                </div>
                <div class="form-group">
